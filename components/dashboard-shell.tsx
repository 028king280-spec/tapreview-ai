...
import { BarChart3, CreditCard, LayoutDashboard, MessageSquare, Settings, Store, WandSparkles } from 'lucide-react'
import { ROUTES } from '@/lib/routes'

const nav = [
  [ROUTES.dashboard, 'Overview', LayoutDashboard],
  [ROUTES.reviews, 'Reviews', MessageSquare],
  [ROUTES.insights, 'AI insights', BarChart3],
  [ROUTES.nfc, 'NFC cards', CreditCard],
  [ROUTES.business, 'Business profile', Store],
  [ROUTES.aiAgent, 'AI agent', WandSparkles],
] as const
